...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed bottom-24 right-2 z-[100] flex max-h-screen w-auto max-w-[80vw] flex-col gap-2 p-2 sm:bottom-4 sm:right-4 sm:max-w-[420px]',
      className,
    )}
    {...props}
  />
